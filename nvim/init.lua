...
-- TODO try minimalist approach https://youtu.be/skW3clVG5Fo?si=WUskQGAhrrG9OhBs
--[[
...
-- Automatically execute .nvim.lua, .nvimrc, and .exrc files in the current directory
vim.opt.exrc = true
...
require('lazy').setup({
  ...
  -- -- LSP diagnostics, code actions, and more
  -- {
